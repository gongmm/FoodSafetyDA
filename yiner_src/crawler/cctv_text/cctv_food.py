...
def spider_food(begin,end):
    ...
    my_set = db.foodnews  # 使用newspeople集合，没有则自动创建
...
if __name__ == '__main__':
    ...
    #get_news_url('https://search.cctv.com/search.php?qtext=食品安全&sort=relevance&type=web&vtime=&datepid=1&channel=&page=1')
    spider_food(1,100)