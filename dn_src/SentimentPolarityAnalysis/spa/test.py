...
class Test:
    ...
    def test_svm(self):
        ...
        # y_pred_prob=svm.predict_proba(self.test_data)
        # list_log.append(self.test_labels)
        # list_log.append(y_pred_prob)
        # with open('../log/test_lable.txt','w',encoding='utf-8') as flog:
        #     for fp in list_log:
        #         flog.write(str(fp))
        #         flog.write('\n')
